...
<div class="container">
	<div class="border border-primary p-4">
			...
			<img alt="강의 커리큘럼" src="${pageContext.request.contextPath}/resources/lectureImg/${viewInfo.viewLectureImg[0].lectureImg}" width="100%" height="1000" class="mx-auto d-block " onerror="this.src='./resources/icon/logo.jpg'"/>	
