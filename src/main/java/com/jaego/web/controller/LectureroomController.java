...
public class LectureroomController {
	...
	public String list(@ModelAttribute("LectureroomDto") LectureroomDto lectureroom,
		...
		System.out.println("렉쳐아이디 : " + lectureroom.getLectureId());
	...
	public String delete(
		...
		System.out.println("delete post의 lectureroomId : " + lectureroomId);
...
//		lectureroomDto.setLectureroomPassword(pwd);
		System.out.println("삭제 룸아이디"+lectureroomDto.getLectureroomId());
		System.out.println("삭제 룸비번"+lectureroomDto.getLectureroomPassword());
